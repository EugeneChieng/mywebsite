...
function loadData() {
  ...
  onValue(articleRef, snapshot => {
    ...
    let { title, content, id, imageURL, author, date, day, length } = snapshot.val()
    ...
    content__article.innerText = content
    image__article.value = imageURL
    image__article.style.backgroundImage = `url(${imageURL})`
